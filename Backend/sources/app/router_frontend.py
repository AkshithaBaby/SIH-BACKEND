...
_SEED_DATA: Dict[str, List[tuple]] = {
    "LVM3_STAGE_02": [
        ...
        ("PART_010", 48.0, 49.5, 51.0, 52.0),   # ← spatial outlier
        ...
        ("PART_025", 11.0, 22.0, 30.5, 39.0),   # ← thermal drift reject
    ...
    "PSLV_LOT_07": [
        ("PART_P01", 41.5, 43.0, 43.5, 44.0),   # ← spatial outlier
    ...
    "GSLV_LOT_03": [
        ("PART_G01", 14.0, 26.0, 37.5, 48.5),   # ← thermal drift near threshold
        ("PART_G02", 15.0, 28.5, 42.0, 54.2),   # ← thermal drift reject
